...
func _ready() -> void:
	...
	for child in get_children():
		if is_light:
			...
			child.material_override = preload("res://peice_meshs/3D/white_piece_material.tres")
			...
			child.material_override = preload("res://peice_meshs/3D/black_piece_material.tres")
			child.rotation_degrees.y += 90
